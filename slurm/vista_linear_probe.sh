#!/bin/bash
#SBATCH -J linprobe
#SBATCH -o logs/linprobe_%j.out
#SBATCH -e logs/linprobe_%j.err
#SBATCH -p gh-dev
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 00:25:00
#SBATCH -A ATM23014
#
# Error-budget split of the loss. See slurm/linear_probe_body.sh for the
...
export OUT="image_outputs/linear_probe"


source slurm/linear_probe_body.sh
